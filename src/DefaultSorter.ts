...
@Component({
    ...
    template: `
        <a style="cursor: pointer" (click)="sort()" class="text-nowrap">
            ...
            <span *ngIf="isSortedByMeAsc" class="dt--icon_sort glyphicon glyphicon-sort-by-attributes" aria-hidden="true"></span>
            <span *ngIf="isSortedByMeDesc" class="dt--icon_sort glyphicon glyphicon-sort-by-attributes-alt" aria-hidden="true"></span>
        </a>`
})
